...
if params.num_nodes < 1:
    pc.reportError(portal.ParameterError("You must request at least 1 node "))
pc.verifyParameters()
lan = request.LAN("lan1")
lan.setJumboFrames()
for i in range(params.num_nodes):
    nodes.append(request.RawPC("node%s" % i))
